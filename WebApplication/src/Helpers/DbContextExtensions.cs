...
namespace WebApplication.Helpers
{
    ...
    {
        public static List<PropertyInfo> GetDbSetProperties(this UserDbContext context)
        {
        ...
        public static void ApplyOnModelCreatingFromAllEntities(this UserDbContext context, ModelBuilder builder)
        {
